...
@Component
public class BaseTest_mainnet_zx {
    ...
    public PoolServiceImpl poolServiceImpl;
    public EpochServiceImpl epochServiceImpl;

    public BaseTest_mainnet_zx() {
        String blockfrostCardanoTestnetProjectId = EncryptedPropertyConfigurer.map.get("blockfrost.cardano.mainnet.project.id");

        backendService =
                new BFBackendService(Constants.BLOCKFROST_MAINNET_URL, blockfrostCardanoTestnetProjectId);
//                new KoiosBackendService(KOIOS_TESTNET_URL);
        accountServiceImpl  = new AccountServiceImpl(Constants.BLOCKFROST_MAINNET_URL, blockfrostCardanoTestnetProjectId);
        addressServiceImpl = new AddressServiceImpl(Constants.BLOCKFROST_MAINNET_URL, blockfrostCardanoTestnetProjectId);
        poolServiceImpl = new PoolServiceImpl(Constants.BLOCKFROST_MAINNET_URL, blockfrostCardanoTestnetProjectId);
        epochServiceImpl = new EpochServiceImpl(Constants.BLOCKFROST_MAINNET_URL, blockfrostCardanoTestnetProjectId);
